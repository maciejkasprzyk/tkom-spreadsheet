...
let ParserRules = [
    ...
    {"name": "program$ebnf$1$subexpression$1", "symbols": [(lexer.has("end") ? {type: "end"} : end), "statement"]},
    {
        "name": "program$ebnf$1",
    ...
    {
        "name": "assigment",
        "symbols": ["expr", (lexer.has("assign") ? {type: "assign"} : assign), "expr"],
        "postprocess": p.assigment
    }
];
