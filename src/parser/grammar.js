...
let ParserRules = [
    ...
    {"name": "code$ebnf$1$subexpression$1$ebnf$1$subexpression$1", "symbols": [(lexer.has("end") ? {type: "end"} : end)]},
    {"name": "code$ebnf$1$subexpression$1$ebnf$1", "symbols": ["code$ebnf$1$subexpression$1$ebnf$1$subexpression$1"]},
    {"name": "code$ebnf$1$subexpression$1$ebnf$1$subexpression$2", "symbols": [(lexer.has("end") ? {type: "end"} : end)]},
    {"name": "code$ebnf$1$subexpression$1$ebnf$1", "symbols": ["code$ebnf$1$subexpression$1$ebnf$1", "code$ebnf$1$subexpression$1$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "code$ebnf$1$subexpression$1", "symbols": ["code$ebnf$1$subexpression$1$ebnf$1", "statement"]},
