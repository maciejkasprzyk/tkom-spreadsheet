...
let ParserRules = [
    ...
    {"name": "entry", "symbols": ["program"]},
    {"name": "program$ebnf$1", "symbols": []},
    {"name": "program$ebnf$1$subexpression$1$ebnf$1$subexpression$1", "symbols": [(lexer.has("end") ? {type: "end"} : end)]},
    {"name": "program$ebnf$1$subexpression$1$ebnf$1", "symbols": ["program$ebnf$1$subexpression$1$ebnf$1$subexpression$1"]},
    {"name": "program$ebnf$1$subexpression$1$ebnf$1$subexpression$2", "symbols": [(lexer.has("end") ? {type: "end"} : end)]},
    {"name": "program$ebnf$1$subexpression$1$ebnf$1", "symbols": ["program$ebnf$1$subexpression$1$ebnf$1", "program$ebnf$1$subexpression$1$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "program$ebnf$1$subexpression$1", "symbols": ["program$ebnf$1$subexpression$1$ebnf$1", "statement"]},
    ...
    {"name": "program", "symbols": ["statement", "program$ebnf$1"], "postprocess": p.list},
    {"name": "statement", "symbols": ["expr"], "postprocess": p.expr},
    {"name": "statement", "symbols": ["assigment"], "postprocess": id},
    {"name": "statement", "symbols": ["block", (lexer.has("end") ? {type: "end"} : end), (lexer.has("indent") ? {type: "indent"} : indent), "program", (lexer.has("dedent") ? {type: "dedent"} : dedent)], "postprocess": id},
    {"name": "assigment", "symbols": ["expr", (lexer.has("assign") ? {type: "assign"} : assign), "expr"], "postprocess": p.assigment},
    {"name": "block", "symbols": [(lexer.has("kwWhile") ? {type: "kwWhile"} : kwWhile), "expr"]}
];
